...
{
    // SUPPORT FOR BOTH FIRMWARES ADDED
...
{
    // LOGIC TO HANDLE BOTH PX4 AND ARDUPILOT ADDED
    if (autopilotType == MAV_AUTOPILOT_PX4 || autopilotType == MAV_AUTOPILOT_ARDUPILOTMEGA) {
        if (!_pluginInstance) {
